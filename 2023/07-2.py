...
for line in lines:
  ...
  # Get hand type
  cardstmp = [*hand]
  replacements = {'2':'02','3':'03','4':'04','5':'05','6':'06','7':'07','8':'08','9':'09','T':'10', 'J':'01', 'Q':'12', 'K':'13', 'A':'14'}
  replacer = replacements.get
  cards = [replacer(n, n) for n in cardstmp]
  
  max_count = wc_count = cards.count('01')
  wc_value = '0'
  ...
  for card in cards:
    if card == '01':
      continue
    count = cards.count(card) + wc_count
    if count > max_count:
      max_count = count
      wc_value = card
  
  second_count = 0
  # Find secondary pairs
  for card in cards:
    if card == '01' or card == wc_value:
      continue
  ...
  if max_count == 5:
    ...
    print(index, "AHHH", wc_count, max_count)
